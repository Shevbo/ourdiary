    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-semibold text-sm tracking-widest uppercase">Shectory</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-500 text-xs">v0.1.0</span>
        </div>
      </header>
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:px-16 lg:py-20">
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Наш дневник</h1>
                <p className="text-slate-400 text-sm">Семейная социальная сеть</p>
              </div>
            </div>

            <p className="text-slate-300 text-lg leading-relaxed mb-10">
              Место, где семья живёт вместе — отмечает события, планирует будущее,
              следит за расходами и растёт в рейтинге семьянина.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <FeatureCard
                icon={<BookHeart className="w-5 h-5 text-rose-400" />}
                title="Лента событий"
        ...
        <div className="lg:w-96 flex items-center justify-center px-8 py-12 lg:py-20">
          <div className="w-full max-w-sm">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
              <h2 className="text-white text-xl font-semibold mb-2">Вход в систему</h2>
              <p className="text-slate-400 text-sm mb-6">Единый каталог пользователей Shectory</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                  />
                </div>
                <div>
                  <label className="block text-slate-300 text-sm font-medium mb-1.5">
...
function FeatureCard({
  ...
  return (
    <div className={`rounded-xl border p-4 ${bgMap[color] ?? "bg-white/5 border-white/10"}`}>
